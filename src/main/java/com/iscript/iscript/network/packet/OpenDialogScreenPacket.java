...
public class OpenDialogScreenPacket {
    ...
    private final String[] optionTargets;
    ...
    public OpenDialogScreenPacket(DialogData dialog) {
        ...
        this.optionTargets = new String[optionCount];
        for (int i = 0; i < optionCount; i++) {
            ...
            this.optionTargets[i] = opt.getTargetDialogId();
        }
    }
    ...
    public OpenDialogScreenPacket(FriendlyByteBuf buf) {
        ...
        for (int i = 0; i < optionCount; i++) {
            ...
            this.optionTargets[i] = buf.readUtf(32767);
        }
    }
    ...
    public void handle(Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            for (int i = 0; i < optionCount; i++) {
                ...
                opt.setTargetDialogId(optionTargets[i]);
