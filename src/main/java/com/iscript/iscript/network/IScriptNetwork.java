...
public class IScriptNetwork {
    ...
    public static void register() {
        ...
        INSTANCE.messageBuilder(RequestStateMachinesPacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(RequestStateMachinesPacket::encode)
                .decoder(RequestStateMachinesPacket::decode)
                .consumerMainThread(RequestStateMachinesPacket::handle)
                .add();

        INSTANCE.messageBuilder(RequestStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(RequestStateMachinePacket::encode)
                .decoder(RequestStateMachinePacket::decode)
                .consumerMainThread(RequestStateMachinePacket::handle)
                .add();

        INSTANCE.messageBuilder(SaveStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(SaveStateMachinePacket::encode)
                .decoder(SaveStateMachinePacket::decode)
                .consumerMainThread(SaveStateMachinePacket::handle)
                .add();

        INSTANCE.messageBuilder(RenameStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(RenameStateMachinePacket::encode)
                .decoder(RenameStateMachinePacket::decode)
                .consumerMainThread(RenameStateMachinePacket::handle)
                .add();

        INSTANCE.messageBuilder(DeleteStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(DeleteStateMachinePacket::encode)
                .decoder(DeleteStateMachinePacket::decode)
                .consumerMainThread(DeleteStateMachinePacket::handle)
                .add();

        INSTANCE.messageBuilder(SyncStateMachinesPacket.class, id++, NetworkDirection.PLAY_TO_CLIENT)
                .encoder(SyncStateMachinesPacket::encode)
                .decoder(SyncStateMachinesPacket::decode)
                .consumerMainThread(SyncStateMachinesPacket::handle)
                .add();

        INSTANCE.messageBuilder(SyncStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_CLIENT)
                .encoder(SyncStateMachinePacket::encode)
                .decoder(SyncStateMachinePacket::decode)
                .consumerMainThread(SyncStateMachinePacket::handle)
                .add();

        INSTANCE.messageBuilder(DuplicateStateMachinePacket.class, id++, NetworkDirection.PLAY_TO_SERVER)
                .encoder(DuplicateStateMachinePacket::encode)
                .decoder(DuplicateStateMachinePacket::decode)
                .consumerMainThread(DuplicateStateMachinePacket::handle)
                .add();
    }
