...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<com.iscript.iscript.blockentities.RegionBlockEntity>> REGION_BE = BLOCK_ENTITIES.register("region_be",
            () -> BlockEntityType.Builder.of(com.iscript.iscript.blockentities.RegionBlockEntity::new, ModBlocks.REGION_BLOCK.get()).build(null));
