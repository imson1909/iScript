...
import com.iscript.iscript.client.render.ScriptBlockEntityRenderer;
...
public class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        BlockEntityRenderers.register(com.iscript.iscript.registry.ModBlockEntities.SCRIPT_BLOCK_ENTITY.get(), ScriptBlockEntityRenderer::new);
    }
}