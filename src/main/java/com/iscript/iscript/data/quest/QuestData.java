...
public class QuestData {
    ...
    private String objectiveType = "none";
    ...
    public void setObjectiveType(String type) { this.objectiveType = type; }
    ...
    public void save(CompoundTag tag) {
        ...
        tag.putString("ObjectiveType", this.objectiveType);
    ...
    public void load(CompoundTag tag) {
        ...
        this.objectiveType = tag.getString("ObjectiveType");
