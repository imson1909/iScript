...
public class ServerCutsceneHandler {
    ...
    public static void play(ServerPlayer player, CutsceneData data, float speed, int startTick) {
        ...
        IScriptNetwork.sendToPlayer(new ClientEffectPacket(ClientEffectPacket.Type.START_CUTSCENE_CLIENT, ClientEffectPacket.startCutsceneToTag(data, speed)), player);
    ...
    public static void pause(ServerPlayer player) {
        ...
        if (inst != null) {
            inst.paused = true;
            IScriptNetwork.sendToPlayer(new ClientEffectPacket(ClientEffectPacket.Type.PAUSE_CUTSCENE_CLIENT, new CompoundTag()), player);
        }
    }
    ...
    public static void resume(ServerPlayer player, float speed, int startTick) {
        ...
        if (inst != null) {
            ...
            IScriptNetwork.sendToPlayer(new ClientEffectPacket(ClientEffectPacket.Type.RESUME_CUTSCENE_CLIENT, ClientEffectPacket.resumeCutsceneToTag(speed, startTick)), player);
        }
    }
    ...
    public static void stop(ServerPlayer player, boolean resetPosition) {
        ...
        if (inst != null) {
            IScriptNetwork.sendToPlayer(new ClientEffectPacket(ClientEffectPacket.Type.STOP_CUTSCENE_CLIENT, ClientEffectPacket.stopCutsceneToTag(resetPosition)), player);
            if (resetPosition) {
