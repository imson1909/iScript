...
public class DialogListSubScreen extends DashboardScreen.SubScreen {
    ...
    private void runDialog() {
        ...
        IScriptNetwork.sendToServer(new RequestDialogPacket(selectedId + ":" + currentDialog.getStartNodeId()));
    }
    ...
    private void saveDialog() {
        if (currentDialog == null) return;
        IScriptNetwork.sendToServer(new SaveDialogGraphPacket(currentDialog));
    }
