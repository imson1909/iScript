...
public class ScriptListSubScreen extends DashboardScreen.SubScreen {
    ...
    private void sendSave() {
        ...
        lastSentText = text;
        IScriptNetwork.sendToServer(new ServerCommandPacket(ServerCommandPacket.Type.SAVE_SCRIPT_TEXT, ServerCommandPacket.saveScriptTextToTag(editorScriptId, text)));
    }
    ...
    private void runScript() {
        ...
        IScriptNetwork.sendToServer(new ServerCommandPacket(ServerCommandPacket.Type.RUN_SCRIPT, ServerCommandPacket.runScriptToTag(editorScriptId)));
    }
            ...
            if (selectedId != null && graphs.containsKey(selectedId)) {
                if (editBox == null || !selectedId.equals(editorScriptId)) {
                    ...
                    if (!pendingEditorText.isEmpty()) {
                        ...
                        IScriptNetwork.sendToServer(new ServerCommandPacket(ServerCommandPacket.Type.REQUEST_SCRIPT_CONTENT, ServerCommandPacket.requestScriptToTag(selectedId)));
