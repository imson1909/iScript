...
public class QuestListSubScreen extends DashboardScreen.SubScreen {
    ...
    private int prereqMenuScroll = 0;
    ...
    public QuestListSubScreen(DashboardScreen parent) {
        super(parent);
    }
    ...
    private void createEditorWidgets(QuestData quest) {
        ...
        titleBox = new EditBox(this.minecraft.font, 0, 0, 100, 18, I18n.t("iscript.quest.editor.placeholder.title"));
        titleBox.setValue(quest.getTitle());
        titleBox.setResponder(s -> saveDebounce = 10);
        parent.addWidget(titleBox);

        descBox = new MultiLineEditBox(this.minecraft.font, 0, 0, 100, 50, I18n.t("iscript.quest.editor.placeholder.description"), Component.empty());
        descBox.setValue(quest.getDescription());
        descBox.setOnValueChanged(() -> saveDebounce = 10);
        parent.addWidget(descBox);

        giverBox = new EditBox(this.minecraft.font, 0, 0, 100, 18, I18n.t("iscript.quest.editor.placeholder.giver_npc"));
        giverBox.setValue(quest.getGiverNpcId());
        giverBox.setResponder(s -> saveDebounce = 10);
        parent.addWidget(giverBox);

        turnInBox = new EditBox(this.minecraft.font, 0, 0, 100, 18, I18n.t("iscript.quest.editor.placeholder.turnin_npc"));
    ...
    private void createSearchBox() {
        ...
        searchBox = new EditBox(this.minecraft.font, rightX + 4, y + 4, RIGHT_PANEL_WIDTH - 8, 16, I18n.t("iscript.quest.list.search"));
    ...
    private void openNameDialog(String mode, String oldId) {
        ...
        nameInputBox = new EditBox(this.minecraft.font, cx - 100, nameDialogY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.quest_name"));
    ...
    private void openAddStageDialog() {
        ...
        stageIdBox = new EditBox(this.minecraft.font, cx - 100, addStageY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.stage_id"));
        stageIdBox.setMaxLength(64);
        stageDescBox = new EditBox(this.minecraft.font, cx - 100, addStageY + 48, 200, 20, I18n.t("iscript.quest.editor.placeholder.description"));
    ...
    private void openAddObjectiveDialog(int stageIdx) {
        ...
        objTargetBox = new EditBox(this.minecraft.font, cx - 100, addObjectiveY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.target"));
        objTargetBox.setMaxLength(128);
        objCountBox = new EditBox(this.minecraft.font, cx - 100, addObjectiveY + 46, 200, 20, I18n.t("iscript.quest.editor.placeholder.count"));
        objCountBox.setValue("1");
        objCountBox.setFilter(s -> s.matches("d*"));
        objDescBox = new EditBox(this.minecraft.font, cx - 100, addObjectiveY + 72, 200, 20, I18n.t("iscript.quest.editor.placeholder.description"));
    ...
    private void openAddItemRewardDialog() {
        ...
        int cx = DashboardScreen.SIDEBAR_W + (this.parent.width - DashboardScreen.SIDEBAR_W) / 2;
        rewardItemBox = new EditBox(this.minecraft.font, cx - 100, addItemRewardY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.item_id"));
        rewardItemBox.setMaxLength(128);
        rewardItemCountBox = new EditBox(this.minecraft.font, cx - 100, addItemRewardY + 46, 200, 20, I18n.t("iscript.quest.editor.placeholder.count"));
    ...
    private void openItemPicker() {
        ...
        itemPickerScroll = 0;
        int cx = DashboardScreen.SIDEBAR_W + (this.parent.width - DashboardScreen.SIDEBAR_W) / 2;
        itemPickerSearchBox = new EditBox(this.minecraft.font, cx - 100, itemPickerY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.search"));
        ...
        rewardItemCountBox = new EditBox(this.minecraft.font, cx - 100, itemPickerY + 156, 200, 20, I18n.t("iscript.quest.editor.placeholder.count"));
        rewardItemCountBox.setValue("1");
        rewardItemCountBox.setFilter(s -> s.matches("\\d*"));
        parent.addWidget(rewardItemCountBox);
        filterItemPicker();
    ...
    private void openEditExpDialog() {
        ...
        int cx = DashboardScreen.SIDEBAR_W + (this.parent.width - DashboardScreen.SIDEBAR_W) / 2;
        QuestData quest = DataAccess.quest(selectedId);
        editExpBox = new EditBox(this.minecraft.font, cx - 100, editExpY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.exp"));
    ...
    private void openEditCommandDialog() {
        ...
        int cx = DashboardScreen.SIDEBAR_W + (this.parent.width - DashboardScreen.SIDEBAR_W) / 2;
        QuestData quest = DataAccess.quest(selectedId);
        editCmdBox = new EditBox(this.minecraft.font, cx - 100, editCmdY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.command"));
    ...
    private void openEditTitleDialog() {
        ...
        int cx = DashboardScreen.SIDEBAR_W + (this.parent.width - DashboardScreen.SIDEBAR_W) / 2;
        QuestData quest = DataAccess.quest(selectedId);
        editTitleBox = new EditBox(this.minecraft.font, cx - 100, editTitleY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.reward_title"));
    ...
    private void openEditItemCountDialog(int idx) {
        ...
        editItemCountBox = new EditBox(this.minecraft.font, cx - 100, editItemCountY + 20, 200, 20, I18n.t("iscript.quest.editor.placeholder.count"));
        ...
        if (!modalOpen) {
            ...
            if (selectedId != null && quests.containsKey(selectedId)) {
                ...
                for (int i = 0; i < tabs.length; i++) {
                    ...
                    graphics.drawCenteredString(font, tabs[i], tx + tabW / 2 - 1, dy + 5, editorTab == i ? Theme.ACCENT : Theme.TEXT);
                }
                dy += 22;
    ...
    private void renderPrereqMenu(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        Collections.sort(ids);
        int mw = 140;
        int visible = Math.min(ids.size() - prereqMenuScroll, 10);
        int mh = visible * 20 + 4;
        ...
        for (int i = prereqMenuScroll; i < Math.min(ids.size(), prereqMenuScroll + 10); i++) {
    ...
    private void renderContextMenu(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        for (String action : actions) {
            ...
            String label = switch (action) {
                case "Copy" -> I18n.s("iscript.quest.editor.context.copy");
                case "Paste" -> I18n.s("iscript.quest.editor.context.paste");
                case "Rename" -> I18n.s("iscript.quest.editor.context.rename");
                case "Duplicate" -> I18n.s("iscript.quest.editor.context.duplicate");
                case "Delete" -> I18n.s("iscript.quest.editor.context.delete");
                default -> action;
            };
