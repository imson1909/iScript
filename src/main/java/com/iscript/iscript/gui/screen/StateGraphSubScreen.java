...
public class StateGraphSubScreen extends DashboardScreen.SubScreen {
    ...
    private void loadMachine() {
        ...
        var data = StateMachineManager.getClientMachineData(machineId);
        if (data == null) return;
        ...
        for (var nodeData : data.nodes) {
            ...
            for (var trans : nodeData.transitions) {
    ...
    public static class ClientNodeData {
        public String id;
        public String name;
        public int color;
        public int posX;
    ...
    public static class ClientTransitionData {
        public String targetNode;
        public boolean auto;
    }

    public static class ClientMachineData {
