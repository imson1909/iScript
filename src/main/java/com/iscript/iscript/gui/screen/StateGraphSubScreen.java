...
public class StateGraphSubScreen extends DashboardScreen.SubScreen {
    ...
    private void saveMachine() {
        ...
        IScriptNetwork.sendToServer(new ServerCommandPacket(ServerCommandPacket.Type.SAVE_STATE_MACHINE, ServerCommandPacket.saveStateMachineToTag(machineId, machineName, getEntryNode(), nodesJson.toString())));
    }
