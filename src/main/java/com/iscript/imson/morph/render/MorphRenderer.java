package com.iscript.imson.morph.render;
...
import com.iscript.imson.morph.model.Cube;
...
public class MorphRenderer {
    ...
    private static void renderCube(Cube cube, GeoModel model, PoseStack poseStack,
        ...
        float x2 = origin[0] / 16f;
        float x1 = (origin[0] - size[0]) / 16f;
        float y1 = origin[1] / 16f;
        float z1 = origin[2] / 16f;
        float h = size[1] / 16f;
        float d = size[2] / 16f;
