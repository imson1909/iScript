...
import com.iscript.imson.gui.screen.DialogScreen;
import com.iscript.imson.gui.screen.NPCEditScreen;
import com.iscript.imson.gui.screen.NPCTradeScreen;
import com.iscript.imson.gui.screen.QuestJournalScreen;
import com.iscript.imson.gui.screen.RegionEditScreen;
import com.iscript.imson.gui.screen.ScriptBlockScreen;
...
public class OpenGuiPacket {
    ...
    private static void handleScriptBlock(CompoundTag data) {
        ...
        Minecraft.getInstance().setScreen(new ScriptBlockScreen(
                pos, data.getString("ScriptId"), data.getString("Script")
        ));
    }
