...
import com.iscript.imson.item.ScriptItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> REGION_BLOCK_ITEM = ITEMS.register("region_block",
            () -> new BlockItem(ModBlocks.REGION_BLOCK.get(), new Item.Properties()));
