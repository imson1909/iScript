package com.iscript.imson.registry;
...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<com.iscript.imson.blockentities.RegionBlockEntity>> REGION_BE = BLOCK_ENTITIES.register("region_be",
            () -> BlockEntityType.Builder.of(com.iscript.imson.blockentities.RegionBlockEntity::new, ModBlocks.REGION_BLOCK.get()).build(null));
