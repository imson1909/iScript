...
import com.iscript.imson.capability.PlayerDataProvider;
import com.iscript.imson.capability.PlayerQuestProvider;
...
public class ForgeEvents {
    ...
    public static void onServerStopping(net.minecraftforge.event.server.ServerStoppingEvent event) {
        ModData.shutdown();
        com.iscript.imson.data.GlobalStates.shutdown();
    }
